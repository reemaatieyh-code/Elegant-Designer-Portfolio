...
export const projects: Project[] = [
  {
    ...
    role: "Art Direction, Social Media Design",
  ...
  },
  {
    ...
    category: "Editorial Design",
    year: "2023",
    description: "Art direction and layout for a bi-annual architecture and interiors publication.",
    ...
    <section id="portfolio" data-testid="portfolio-section" className="section-pad border-t border-border">
      <div className="max-w-[1400px] mx-auto">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-16 md:mb-20">
          <div>
            <p className="label-sm mb-5">Selected Work</p>
            <h2 className="font-serif font-light text-[clamp(3rem,6vw,5.5rem)] text-foreground">
              Portfolio
            </h2>
          </div>
          <p className="font-sans text-sm text-muted-foreground max-w-xs font-light leading-relaxed">
            A curated selection of projects spanning identity, editorial, digital, and motion design.
          </p>
        </div>
        ...
        >
          {categories.map((cat) => (
            <button
              ...
              className={`font-sans text-[10px] tracking-[0.2em] uppercase px-5 py-2 border transition-all duration-300 ${
                active === cat
              ...
              >
                ...
                <div className="relative overflow-hidden">
                  ...
                  <div className="absolute inset-0 bg-foreground/0 group-hover:bg-foreground/55 transition-all duration-500 flex items-center justify-center">
                    <span className="opacity-0 group-hover:opacity-100 transition-all duration-300 translate-y-3 group-hover:translate-y-0 font-sans text-[11px] tracking-[0.25em] uppercase text-background flex items-center gap-2">
                      View Case Study <ArrowRight size={13} strokeWidth={1.5} />
                    </span>
                  </div>
                  {/* Year badge */}
                  <span className="absolute top-5 right-5 label-sm text-white/60">{project.year}</span>
                </div>

                {/* Info */}
                <div className="p-8 flex items-start justify-between gap-6 border-t border-border">
                  ...
                  <button
                    className="shrink-0 mt-1 w-10 h-10 border border-border flex items-center justify-center text-muted-foreground group-hover:border-primary group-hover:text-primary group-hover:bg-primary group-hover:text-white transition-all duration-300"

...
export const projects: Project[] = [
  ...
  {
  id: 3,
  slug: "voucher-packaging-design",
  title: "Voucher & Packaging Box Design",
  category: "Packaging & Print Design",
  year: "2024",
  description:
    "A packaging and voucher design project combining printed coupon design with a custom box presentation.",
  detail:
    "A complete print design project including a voucher/coupon card and packaging box design. The visual direction focuses on clean brand presentation, gift-ready packaging, and practical print layout for commercial use.",
  role: "Packaging Design, Voucher Design, Print Design",
  bg: "linear-gradient(160deg, #C9A89E 0%, #B98273 60%, #7A4F45 100%)",
  bgAlt: "linear-gradient(135deg, #E6C7BC 0%, #C79484 100%)",
  bgAlt2: "linear-gradient(160deg, #F2E6E0 0%, #D8B0A2 100%)",
  palette: ["#C9A89E", "#B98273", "#7A4F45", "#F2E6E0"],
},
  {
    id: 4, slug: "zafran-spice", title: "Zafran Spice Co.",
    category: "Packaging & Print Design", year: "2023",
    ...
    role: "Packaging & Print Design, Illustration Direction",

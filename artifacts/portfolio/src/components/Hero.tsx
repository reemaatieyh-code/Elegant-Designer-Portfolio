  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[0.9fr_520px] gap-0 items-center">
        <motion.div
          {...fadeUp(0.35)}
          className={`${isRTL ? "text-right" : ""} lg:translate-x-20`}
        >
          <h1
            className="font-light text-[clamp(6rem,11.5vw,11.5rem)] leading-[0.88] text-[#171311]"
        ...
        <motion.div
          className={`flex flex-col gap-8 ${isRTL ? "items-end text-right" : ""}`}
          {...fadeUp(0.5)}
        >
          <p
      ...
      <motion.div
        className={`mt-16 md:mt-20 flex items-center ${isRTL ? "flex-row-reverse" : ""}`}
        {...fadeUp(0.65)}
      >

  ...
  return (
    ...
    >
      ...
      <div className="lg:translate-x-16">
        ...
        {/* MAIN GRID */}
        <div className="grid grid-cols-1 lg:grid-cols-[0.82fr_520px] items-center gap-4 lg:gap-0">
          
          {/* BIG NAME */}
          <motion.div
            {...fadeUp(0.35)}
            className={`${isRTL ? "text-right" : ""} -mr-8`}
          >
            <h1
              data-testid="hero-name"
              className="font-light text-[clamp(6rem,11vw,11rem)] leading-[0.88] tracking-[-0.03em] text-[#171311]"
              style={{
                fontFamily:
          ...
          <motion.div
            {...fadeUp(0.5)}
            className={`flex flex-col gap-8 lg:-ml-16 ${
